...
def shoot(textTimeFrame, symbols, location):
    try:
        ...
        mySendKey("//div[@data-dialog-name='Indicators']/div/div/input", "Relative Strength Index")
        myClick("//span[@title='Relative Strength Index']")
        ...
        mySendKey("//div[@data-dialog-name='Mom']//input[@value='10']", "14")
